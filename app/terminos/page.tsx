          ...
          <div className="mt-12 prose prose-lg max-w-none">
            <div className="space-y-8 font-sans text-muted-foreground leading-relaxed">
              <section>
                ...
                <p>
                  Al acceder y utilizar los servicios de Silenceside Ecos,
                  aceptas estar vinculado por estos términos de servicio. Si no
                  estás de acuerdo con alguna parte de estos términos, no podrás
              ...
              <section>
                ...
                <p className="mt-4">
                  Se respetan los cánones de las diferentes escuelas y autores
              ...
              <section>
                ...
                <p>Para participar en nuestros talleres y eventos, debes:</p>
                <ul className="list-disc pl-6 mt-4 space-y-2">
                  <li>Proporcionar información precisa y completa</li>
                  <li>
                    Mantener la confidencialidad de tu información de cuenta
                  </li>
              ...
              <section>
                ...
                <p>
                  Las cancelaciones deben realizarse con al menos 48 horas de
                  anticipación para recibir un reembolso completo. Las
                  cancelaciones tardías pueden estar sujetas a cargos parciales.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Todo el contenido de Silenceside Ecos, incluyendo textos,
                  gráficos, logotipos, imágenes y materiales de los talleres,
              ...
              <section>
                ...
                <p>Al participar en nuestros servicios, te comprometes a:</p>
                <ul className="list-disc pl-6 mt-4 space-y-2">
                  <li>Respetar a otros participantes y facilitadores</li>
                  <li>
                    Mantener la confidencialidad de las experiencias grupales
                  </li>
              ...
              <section>
                ...
                <p>
                  Nuestros servicios están diseñados para el crecimiento
                  personal y el bienestar general. No sustituyen el consejo
                  médico, psicológico o profesional. Silenceside Ecos no se hace
                  responsable de decisiones tomadas basándose en la información
                  proporcionada en nuestros talleres.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Todos los precios están expresados en la moneda indicada. Los
                  pagos se procesan de forma segura a través de nuestros
                  proveedores de pago autorizados. Una vez completada la compra,
