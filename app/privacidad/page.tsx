          ...
          <div className="mt-12 prose prose-lg max-w-none">
            <div className="space-y-8 font-sans text-muted-foreground leading-relaxed">
              <section>
                ...
                <p>
                  En Silenceside Ecos, recopilamos información que nos
                  proporcionas directamente cuando:
                </p>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 mt-4 space-y-2">
                  ...
                  <li>
                    Enviarte información sobre nuestros servicios y eventos
                  </li>
              ...
              <section>
                ...
                <p>
                  ...
                  personal a terceros, excepto cuando sea necesario para:
                </p>
                <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              <section>
                ...
                <p>
                  ...
                  sitio web. Puedes configurar tu navegador para rechazar
              ...
              <section>
                ...
                <p>
                  ...
                  cambios significativos publicando la nueva política en esta
                  página.
                </p>
              </section>
            </div>
